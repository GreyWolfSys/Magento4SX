...
class SecrTxnGrp{
	...
	public function setCAVResultCode($CAVResultCode) {
		$this->CAVVResultCode = $CAVResultCode;
	}
...
class MCGrp{
	...
	private $mCAddData;
	private $finAuthInd;
	private $tranIntgClass;
	private $mCAuthInd;
	private $storedCredenInd;

	public function setBanknetData($BanknetData) {
		$this->BanknetData = $BanknetData ;
	}
	public function getBanknetData() {
		return $this->BanknetData;
	}
	//MCMSDI
    public function setMCMSDIData($MCMSDI) {
		$this->MCMSDI = $MCMSDI ;
	}
	public function getMCMSDIData() {
		return $this->MCMSDI;
	}
	
	//FinAuthInd
	public function setFinAuthIndData($FinAuthInd) {
		$this->FinAuthInd = $FinAuthInd ;
	}
	public function getFinAuthIndData() {
		return $this->FinAuthInd;
	}
	//TranIntgClass
	public function setTranIntgClassData($TranIntgClass) {
		$this->TranIntgClass = $TranIntgClass ;
	}
	public function getTranIntgClassData() {
		return $this->TranIntgClass;
	}
...
class AmexGrp{
    ...
    public function setAmExTranIDData($AmExTranID) {
		$this->AmExTranID = $AmExTranID ;
	}
	public function getAmExTranIDData() {
		return $this->AmExTranID;
	}
	
	public function setAmExPOSDataData($AmExPOSData) {
		$this->AmExPOSData = $AmExPOSData ;
	}
	public function getAmExPOSDataData() {
		return $this->AmExPOSData;
	}
	
    public function setGdSoldCdData($GdSoldCd) {
		$this->GdSoldCd = $GdSoldCd ;
	}
	public function getGdSoldCdData() {
		return $this->GdSoldCd;
	}
	
	public function setReAuthIndData($ReAuthInd) {
		$this->ReAuthInd = $ReAuthInd ;
	}
	public function getReAuthIndData() {
		return $this->ReAuthInd;
	}
	
	public function setAmexAuthIndData($AmexAuthInd) {
		$this->AmexAuthInd = $AmexAuthInd ;
	}
	public function getAmexAuthIndData() {
		return $this->AmexAuthInd;
	}
	
	public function setStoredCrdIndData($StoredCrdInd) {
		$this->StoredCrdInd = $StoredCrdInd ;
	}
	public function getStoredCrdIndData() {
		return $this->StoredCrdInd;
	}
}
...
class DSGrp{
    ...
    public function setDiscProcCodeData($DiscProcCode) {
		$this->DiscProcCode = $DiscProcCode ;
	}
	public function getDiscProcCodeData() {
		return $this->DiscProcCode;
	}
	
    public function setDiscPOSEntrydData($DiscPOSEntryd) {
		$this->DiscPOSEntry = $DiscPOSEntryd ;
	}
	public function getDiscPOSEntrydData() {
		return $this->DiscPOSEntry;
	}
	
	public function setDiscRespCodeData($DiscRespCode) {
		$this->DiscRespCode = $DiscRespCode ;
	}
	public function getDiscRespCodeData() {
		return $this->DiscRespCode;
	}
	
	public function setDiscPOSDataData($DiscPOSData) {
		$this->DiscPOSData = $DiscPOSData ;
	}
	public function getDiscPOSDataData() {
		return $this->DiscPOSData;
	}
	//DiscTransQualifier
	public function setDiscTransQualifierData($DiscTransQualifier) {
		$this->DiscTransQualifier = $DiscTransQualifier ;
	}
	public function getDiscTransQualifierData() {
		return $this->DiscTransQualifier;
	}
	public function setDiscNRIDData($DiscNRID) {
		$this->DiscNRID = $DiscNRID ;
	}
	public function getDiscNRIDData() {
		return $this->DiscNRID;
	}
...
class ECOMMGrp{
	...
	public function setEcommTxnIndData($EcommTxnInd) {
		$this->EcommTxnInd = $EcommTxnInd;
	}
	public function getEcommTxnIndData() {
		return $this->EcommTxnInd;
	}

	public function setEcommURLData($EcommURL) {
		$this->EcommURL = $EcommURL;
	}
	public function getEcommURLData() {
		return $this->EcommURL;
	}
	
	public function setCustSvcPhoneNumberData($CustSvcPhoneNumber) {
		$this->CustSvcPhoneNumber = $CustSvcPhoneNumber;
	}
	public function getCustSvcPhoneNumberData() {
		return $this->CustSvcPhoneNumber;
	}

}
class CustInfoGrp{
	private $avsBillingAddr;
	private $avsBillingPostalCode;

	public function setAVSBillingAddrData($AVSBillingAddr) {
		$this->AVSBillingAddr = $AVSBillingAddr;
	}
	public function getAVSBillingAddrData() {
		return $this->AVSBillingAddr;
	}
	
	public function setAVSBillingPostalCodeData($AVSBillingPostalCode) {
		$this->AVSBillingPostalCode = $AVSBillingPostalCode;
	}
	public function getAVSBillingPostalCodeData() {
		return $this->AVSBillingPostalCode;
	}
	public function setCHFirstNmData($CHFirstNm) {
		$this->CHFirstNm = $CHFirstNm;
	}
	public function getCHFirstNmData() {
		return $this->CHFirstNm;
	}
		
	public function setCHLastNmData($CHLastNm) {
		$this->CHLastNm = $CHLastNm;
	}
	public function getCHLastNmData() {
		return $this->CHLastNm;
	}
}
class OrigAuthGrp{
	private $origAuthID;
	private $origLocalDateTime;
	private $origTranDateTime;
	private $origSTAN;
	private $origRespCode;

	public function setOrigAuthIDData($OrigAuthID) {
	    
        //$this->logger->info("!!!!!");
        //$this->logger->info("!!!!!" . $OrigAuthID);
		$this->OrigAuthID = $OrigAuthID;
	}
	public function getOrigAuthIDData() {
		return $this->OrigAuthID;
	}

	public function setOrigTranDateTimeData($OrigTranDateTime) {
		$this->OrigTranDateTime = $OrigTranDateTime;
	}
	public function getOrigTranDateTimeData() {
		return $this->OrigTranDateTime;
	}
	public function setOrigLocalDateTimeData($OrigLocalDateTime) {
		$this->OrigLocalDateTime = $OrigLocalDateTime;
	}
	public function getOrigLocalDateTimeData() {
		return $this->OrigLocalDateTime;
	}
	public function setOrigSTANData($OrigSTAN) {
		$this->OrigSTAN = $OrigSTAN;
	}
	public function getOrigSTANData() {
		return $this->OrigSTAN;
	}
	public function setOrigRespCodeData($OrigRespCode) {
		$this->OrigRespCode = $OrigRespCode;
	}
	public function getOrigRespCodeData() {
...
class CreditRequestDetails{
	...
	public function setMCGrp(MCGrp $MCGrp) {
		$this->MCGrp = $MCGrp;
	}
	public function getMCGrp() {
		return $this->MCGrp;
	}
	
	public function setDSGrp(DSGrp $DSGrp) {
		$this->DSGrp = $DSGrp;
	}
	public function getDSGrp() {
		return $this->DSGrp;
	}
	
	public function setAmexGrp(AmexGrp $AmexGrp) {
		$this->AmexGrp = $AmexGrp;
	}
	public function getAmexGrp() {
		return $this->AmexGrp;
	}
	
	public function setECOMMGrp(ECOMMGrp $ECOMMGrp) {
		$this->EcommGrp = $ECOMMGrp;
	}
	public function getECOMMGrp() {
		return $this->ECOMMGrp;
	} 
	
	public function setCustInfoGrp(CustInfoGrp $CustInfoGrp) {
		$this->CustInfoGrp = $CustInfoGrp;
	}
	public function getCustInfoGrp() {
		return $this->CustInfoGrp;
	} 
	...
	public function setAddtlAmtGrp2(AddtlAmtGrp $AddtlAmtGrp) {
		$this->AddtlAmtGrp2 = $AddtlAmtGrp;
	}
	public function getAddtlAmtGrp2() {
		return $this->AddtlAmtGrp2;
	}
	...
	public function setOrigAuthGrp(OrigAuthGrp $OrigAuthGrp) {
		$this->OrigAuthGrp = $OrigAuthGrp;
	}
	public function getOrigGrp() {
		return $this->OrigAuthGrp;
	} 
