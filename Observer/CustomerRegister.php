        ...
        try {
            ...
            if ($createcustomer == 1)    {
                if (strpos($this->sx->getConfigValue('apiurl'),'csd') ===false  ){
                	...
                	$GCCustomer=SalesCustomerInsert($cono, $operinit, $custno, $statecd, $name, $addr1, $addr2, $city, $state, $zipcd, $phoneno, $faxphoneno, $siccd, $termstype, $custtype, $salester, $bofl,
                                $subfl, $minord, $maxord, $taxcert, $shipviaty, $whse, $slsrepin, $slsrepout, $shipreqfl, $taxauth, $taxablety, $nontaxtype, $creditmgr, $dunsno, $user1, $user2, $user3,
                                $user4, $user5, $user6, $user7, $user8, $user9, $countrycd, $countycd, $email, $pricetype,
                                $pricecd, $transproc, $addon1, $addon2, $addon3, $addon4, $addon5, $addon6, $addon7, $addon8, $inbndfrtfl, $outbndfrtfl, $custpo, $addr3 ) ;
